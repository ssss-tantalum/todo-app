...
func Index(todos []model.Todo) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<main class=\"flex flex-col items-center justify-center min-h-screen py-2 bg-gray-200\"><h1 class=\"text-4xl font-bold text-gray-700 -mt-32\">Echo-Templ-HTMX Todo-App</h1><div class=\"w-full max-w-xl items-center justify-center mt-5\"><div class=\"w-full px-8 py-6 bg-white shadow-md rounded-lg\">")
